...
public class RouteNetwork<T> extends Network<T> implements RouteNetworkADT<T>
{
    ...
    private enum SEARCH_TYPE
    {
        ...
        LOCATIONS_ANY, //indica uma pesquisa para qualquer localizacao (todos os sitios exceto as bandeiras) mais próximo
    }
    ...
    private DijkstraSupport caminhoMaisCurtoDijkstra(T pontoDePartida)
    {
        ...
        for (int i = 0; i < super.numVertices; i++)
        {
            currentIndex = super.getDistanciaPequenaNode(ds.distance, ds.visited); //obter o indice do node com o peso baixo
